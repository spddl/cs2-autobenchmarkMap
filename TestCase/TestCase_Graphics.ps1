...
for ($i = 0; $i -lt 3; $i++) {
 # number of runs
	$TestCases += @{ Value = ''; Name = 'None' } # The value that will be changed
	$TestCases += @{ Value = 'SwapEffectUpgradeEnable=1;'; Name = 'SwapEffectUpgradeEnable_On' } # Optimizations for windowed games
	$TestCases += @{ Value = 'SwapEffectUpgradeEnable=0;'; Name = 'SwapEffectUpgradeEnable_Off' }
	$TestCases += @{ Value = 'VRROptimizeEnable=1;'; Name = 'VRROptimizeEnable_On' }
	$TestCases += @{ Value = 'VRROptimizeEnable=0;'; Name = 'VRROptimizeEnable_Off' }
}
